...
# 📖 intro  
본 문서는 nanoMC User Guide 문서에서 일부 내용 발췌한 내용입니다.  
nanoMC 사용에 필요한 최소한의 지식을 빠르고 간편하게 전달하기 위해 작성된 문서이며,  
자세한 사용방법은 nanoMC Pacakage를 설치하면 동봉되어 있는 User Guide 문서를 참고해주시기 바랍니다.
